		...
		{%>
			...
			<tr>
	 		<%}
				...
				<td colspan="3"></td>
				<td>
					<button type="button" id="write" class="btn btn-sm btn-danger write" onclick="location.href='index.jsp?main=review/reviewLoginChk.jsp'">글쓰기</button>
				</td>
			</tr>
	</table>
