...
<head>
 ...
 <body>
   ...
   <section class="ftco-section ftco-no-pb"  style="height: 230px; border-top: solid 2px gray; border-bottom: solid 2px gray;">
   
   	작성일 제목, 작성자얼굴 작성자 <span class="subheading">Since 1905</span>
   </section>
