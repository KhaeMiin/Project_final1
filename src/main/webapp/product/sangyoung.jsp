				...
				<div class="desc">
					<p class="meta-prod d-flex">
						<a href="#"
							...
							class="flaticon-shopping-bag"></span></a> <a href="../index.jsp?main=product/productform.jsp?go=sangyoungdetail.jsp"
							class="d-flex align-items-center justify-content-center"><span
							class="flaticon-heart">
							</span></a> <a href="index.jsp?main=product/sangyoungdetail.jsp?num=<%=dto.getNum()%>&currentPage=<%=currentPage%>&keydsds=list"
							class="d-flex align-items-center justify-content-center"><span
