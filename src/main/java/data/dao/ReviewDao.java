...
public class ReviewDao {
	...
	// 이전글 번호 반환
	public int reviewPreNum(String num) {
		Connection conn = db.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int n = 0;
	...
	// 다음글 번호 반환
	public int reviewNextNum(String num) {
		Connection conn = db.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int n = 0;
	...
	// 이전글 제목 반환
	public ReviewDto reviewPre(String num) {
		...
		String sql = "select subject from review where num < ? order by num desc limit 1";
	...
	// 다음글 제목 반환
	public ReviewDto reviewNext(String num) {
		...
		String sql = "select subject from review where num > ? order by num asc limit 1";
